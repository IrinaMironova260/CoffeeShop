package com.example.coffeeshop.presentation.tabs.coffee
...
import com.example.coffeeshop.databinding.CoffeeBinding
...
class Coffee : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = CoffeeBinding.inflate(inflater, container, false)
    ...
    private fun initRecyclerCoffee() {
        ...
        coffeeAdapter =
            CoffeeAdapter ({ coffeeModel: CoffeeModel -> addToCard(coffeeModel)
                ...
                loadCoffeeToCardFromCardProduct(idProduct, addToBasket, removeFromBasket)
            })
    ...
    private fun loadCoffeeToCardFromCardProduct (idProduct:Int,
